...
deploy-userprofile-server:
	...
	gcloud run deploy userprofile-server --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/userprofile-server:latest --port=8080 --max-instances=1 --region=us-central1 --allow-unauthenticated
...
deploy-userprofile-ui:
	...
	gcloud run deploy userprofile-ui --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/userprofile-ui:latest --port=3000 --max-instances=1 --region=us-central1 --allow-unauthenticated
...
deploy-userprofile-diagram:
	...
	gcloud run deploy userprofile-diagram --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/userprofile-diagram:latest --port=3001 --max-instances=1 --region=us-central1 --allow-unauthenticated