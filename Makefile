...
deploy-userprofile-server:
	...
	gcloud run deploy userprofile-server --project=blueprint-8675309 --memory=2G --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/userprofile-server:latest --port=8080 --max-instances=1 --region=us-central1 --allow-unauthenticated
...
deploy-userprofile-ui:
	...
	gcloud run deploy userprofile-ui --project=blueprint-8675309 --memory=2G --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/userprofile-ui:latest --port=3000 --max-instances=1 --region=us-central1 --allow-unauthenticated
