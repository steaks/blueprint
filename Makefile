...
deploy-rectangle-diagram:
	...
	gcloud run deploy rectangle-diagram --project=blueprint-8675309 --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/rectangle-diagram:latest --port=3001 --min-instances=1 --max-instances=1 --region=us-central1 --allow-unauthenticated