...
deploy-rectangle-server:
	...
	gcloud run deploy rectangle-server --project=blueprint-8675309 --memory=2Gi --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/rectangle-server:latest --port=8080 --max-instances=1 --region=us-central1 --allow-unauthenticated
...
deploy-rectangle-ui:
	...
	gcloud run deploy rectangle-ui --project=blueprint-8675309 --memory=2Gi --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/rectangle-ui:latest --port=3000 --max-instances=1 --region=us-central1 --allow-unauthenticated

deploy-rectangle-diagram:
	docker build -f Dockerfile.rectangle-diagram --tag rectangle-diagram .
	docker tag rectangle-diagram us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/rectangle-diagram:latest
	docker push us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/rectangle-diagram
	gcloud run deploy rectangle-diagram --project=blueprint-8675309 --image=us-central1-docker.pkg.dev/blueprint-8675309/blueprint-websites/rectangle-diagram:latest --port=3001 --max-instances=1 --region=us-central1 --allow-unauthenticated